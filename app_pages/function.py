...
def show_function_page():
    ...
    with center:
        st.markdown(f"<h2 style='text-align: center; color: {html_header_color_1};'>{texts['center_subtitle1']}</h2>", unsafe_allow_html=True)
        ...
        with step1_block:
            ...
            st.markdown(f"<h4 style='color: {html_header_color_1};'>{texts['step_one']}</h4>", unsafe_allow_html=True)
        ...
        with step2_block:
            st.markdown(f"<h4 style='color: {html_header_color_1};'>{texts['step_two_markdown']}</h4>", unsafe_allow_html=True)
        ...
        with step3_block:
            st.markdown(f"<h4 style='color: {html_header_color_1};'>{texts['step_three_markdown']}</h4>", unsafe_allow_html=True)
        ...
        if uploaded_file is not None and file_valid:
            if st.button(texts['step_three_button']):
                ...
                with analyze_result:
                    ...
                    # else: 
                    #     if selected_model == texts['step_three_selected_model3']:
                    #         selected_model = OPENAI_GPT3
