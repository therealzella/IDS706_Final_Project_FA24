...
def generate_prompt(
    ...
    if input_question:
        ...
        if analysis_focus != "Not Selected":
            system_prompt = (
                common_prompt_part1
                + """1. The analysis should not be comprehensive but should focus on: a. Firstly, filter out customer comments related to """
            ...
            system_prompt = (
                common_prompt_part1
                + "1. The analysis should not be comprehensive, please analyze solely from the perspective of "
            ...
            system_prompt = (
                common_prompt_part1
                + "1. Please categorize and analyze the customer reviews from different perspectives comprehensively, such as the main advantages and disadvantages of the product, its functions, design, user experience, pricing, packaging, customer service, quality of the product, and any other issues raised by customers."
                + common_prompt_part2
            )
